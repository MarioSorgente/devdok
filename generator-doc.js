...
} // End of setupAuthAndFeedback function
  ...
  .addEventListener("submit", async function (e) {
    ...
    try {
      ...
      if (result.documentation) {
        ...
        document.getElementById("renderedContent").innerHTML = marked.parse(
          result.documentation
        );
...
document
  .getElementById("copyRenderedButton")
  .addEventListener("click", function () {
